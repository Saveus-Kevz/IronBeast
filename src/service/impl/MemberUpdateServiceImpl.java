...
public class MemberUpdateServiceImpl implements service.MemberUpdateService {
    ...
    private boolean handleUpdateChoice(int choice, Member member) {
        switch (choice) {
    ...
    private void updateFirstName(Member member) {
    ...
    private void updateLastName(Member member) {
    ...
    private void updateBirthdate(Member member) {
    ...
    private void updateGender(Member member) {
    ...
    private void updateContactNumber(Member member) {
    ...
    private void updateEmailAddress(Member member) {
    ...
    private void updateAddress(Member member) {
    ...
    private void updateAllInformation(Member member) {
